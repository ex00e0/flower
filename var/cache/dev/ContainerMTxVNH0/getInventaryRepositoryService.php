 ...
 */
class getInventaryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InventaryRepository' shared autowired service.
     *
     * @return \App\Repository\InventaryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InventaryRepository.php';

        return $container->privates['App\\Repository\\InventaryRepository'] = new \App\Repository\InventaryRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
